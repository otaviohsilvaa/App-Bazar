...
import { StatusBar, Button, TextInput, Text, View, StyleSheet, Pressable, ScrollView, Alert, Image } from 'react-native';
  ...
  return (
    <ScrollView style={{ flex: 1 }} className="bg-slate-50" showsVerticalScrollIndicator={false}>
      <View style={styles.container}>
        ...
        {/* IMAGEM */}
        <Button title="Selecionar Imagem do Produto" onPress={pickImage} />
        {imagemP && <Image source={{ uri: imagemP }} style={{ width: 100, height: 100, marginVertical: 10 }} />}
